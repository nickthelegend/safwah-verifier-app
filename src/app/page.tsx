    ...
    return (
      <main className="phone-frame" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px", textAlign: "center", background: "#0c0c0e", height: "100%" }}>
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", gap: "24px" }}>
          <div style={{ width: "80px", height: "80px", borderRadius: "24px", background: "linear-gradient(135deg, #EBF5FF 0%, #3B82F6 100%)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 32px rgba(59,130,246,0.25)" }}>
            <span style={{ fontSize: "36px" }}>🔍</span>
          </div>
          <div>
            <h1 style={{ fontFamily: "var(--font-space-grotesk)", fontSize: "28px", fontWeight: "bold", color: "#fff", marginBottom: "8px", background: "linear-gradient(to right, #fff, #3B82F6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Safwah Customs</h1>
            <p style={{ color: "#9CA3AF", fontSize: "14px", maxWidth: "260px", lineHeight: "1.6" }}>Connect your customs officer node wallet to verify claims and approve exit payouts.</p>
          </div>
        </div>
